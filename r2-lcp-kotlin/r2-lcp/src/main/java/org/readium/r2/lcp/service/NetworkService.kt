...
internal class NetworkService {
    ...
    suspend fun download(url: URL, destination: File,usertoken : String): MediaType? = withContext(Dispatchers.IO) {
        try {
            //val connection = url.openConnection() as HttpURLConnection
            /****************************By Vindhya for tokenized request************************************/
            //val urlnew =URL("https://prothumia-hub-v1-dot-model-signifier-297723.uc.r.appspot.com/api/v1/licenses/download/b38b11af-cf0d-4a2f-8c7a-d5b6bc58b079")
